              ...
              children: [
                ...
                Padding(
                  ...
                  child: FutureBuilder<ApiCallResponse>(
                    future: NoticiasVacinacaoCall.call(),
                    builder: (context, snapshot) {
                      ...
                      final columnNoticiasVacinacaoResponse = snapshot.data!;

                      return Builder(
                        builder: (context) {
                          final noticias = (NoticiasVacinacaoCall.noticias(
                                    columnNoticiasVacinacaoResponse.jsonBody,
                                  )?.toList() ??
                                  [])
                              .take(20)
                              .toList();
                          ...
                          return Column(
                            ...
                            children:
                                List.generate(noticias.length, (noticiasIndex) {
