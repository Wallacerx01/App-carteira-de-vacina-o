...
class CarteiraDeVacinaDigitalSupabaseUser extends BaseAuthUser {
  CarteiraDeVacinaDigitalSupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> carteiraDeVacinaDigitalSupabaseUserStream() {
  ...
  return (!loggedIn
    ...
    (authState) {
      currentUser =
          CarteiraDeVacinaDigitalSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
