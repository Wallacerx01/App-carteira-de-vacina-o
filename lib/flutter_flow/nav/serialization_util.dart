  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case UsuarioCampanhasRow:
            return UsuarioCampanhasRow(data);
          case AdministradorRow:
            return AdministradorRow(data);
          case CampanhasRow:
            return CampanhasRow(data);
          case BdAtivoRow:
            return BdAtivoRow(data);
          case VacinasRow:
            return VacinasRow(data);
          case VwDetalhesVacinasUsuarioRow:
            return VwDetalhesVacinasUsuarioRow(data);
          case UsuariosRow:
            return UsuariosRow(data);
          case UsuarioVacinasRow:
            return UsuarioVacinasRow(data);
          case ViewCampanhasUsuarioRow:
            return ViewCampanhasUsuarioRow(data);
          case PostosVacinacaoRow:
            return PostosVacinacaoRow(data);
          default:
            return null;
        }
