...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF4DA1FF);
  late Color secondary = const Color(0xFF39D2C0);
  late Color tertiary = const Color(0xFFA3E4D7);
  late Color alternate = const Color(0xFFF2F4F7);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFFB0BEC5);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFF9F9FA);
  late Color accent2 = const Color(0xFFFFFFFF);
  late Color accent3 = const Color(0xFFF9FAFA);
  late Color accent4 = const Color(0xFFF9F9F9);
  late Color success = const Color(0xFFFEFEFE);
  late Color warning = const Color(0xFF00666A);
  late Color error = const Color(0xFF444242);
